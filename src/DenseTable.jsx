            ...
            <TableRow>
              ...
              {data1.map((row, i) => (
                ...
                >
                  ...
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderRight: '1px solid #212121' }}>{row.oneRaceAgo}</TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee" }}>{row.nextRace1}</TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee" }}>{row.nextRace2}</TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee" }}>{row.nextRace3}</TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee" }}>{row.nextRace4}</TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderRight: '1px solid #212121' }}>{row.nextRace5}</TableCell>
              ...
              {data2.map((row, i) => (
                ...
                >
                  ...
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.fiveRacesAgoReport}  target="_blank" rel="noopener noreferrer">{row.fiveRacesAgo}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.fourRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.fourRacesAgo}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.threeRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.threeRacesAgo}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.twoRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.twoRacesAgo}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121', borderRight: '1px solid #212121' }}><a href={row.oneRaceAgoReport} target="_blank" rel="noopener noreferrer">{row.oneRaceAgo}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderBottom: '1px solid #212121' }}><a href={row.nextRace1Report} target="_blank" rel="noopener noreferrer">{row.nextRace1}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderBottom: '1px solid #212121' }}><a href={row.nextRace2Report} target="_blank" rel="noopener noreferrer">{row.nextRace2}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderBottom: '1px solid #212121' }}><a href={row.nextRace3Report} target="_blank" rel="noopener noreferrer">{row.nextRace3}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderBottom: '1px solid #212121' }}><a href={row.nextRace4Report} target="_blank" rel="noopener noreferrer">{row.nextRace4}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#eeeeee", borderBottom: '1px solid #212121', borderRight: '1px solid #212121' }}><a href={row.nextRace5Report} target="_blank" rel="noopener noreferrer">{row.nextRace5}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.nextRaceType1Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType1}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.nextRaceType2Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType2}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.nextRaceType3Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType3}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.nextRaceType4Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType4}</a></TableCell>
                  <TableCell align="center" sx={{ bgcolor: "#ffffff", borderBottom: '1px solid #212121' }}><a href={row.nextRaceType5Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType5}</a></TableCell>
                </TableRow>
              ))}
            </TableHead>
            <TableBody>
              {data3.map((row, i) => (
                ...
                >
                  ...
                  <TableCell sx = {{ bgcolor: getBackgroundColor(row.oneRaceAgoRating), color: getColor(row.oneRaceAgoRating), borderRight: '1px solid #212121' }} align="center">{boolean1 == true ? row.oneRaceAgo : cellLoading}</TableCell>
                  ...
                  <TableCell sx = {{ bgcolor: getBackgroundColor(row.nextRace5Rating), color: getColor(row.nextRace5Rating), borderRight: '1px solid #212121' }} align="center">{boolean2 == true ? row.nextRace5 : cellLoading}</TableCell>

            ...
            <Table sx={{ maxWidth: 100/100, border: '1px solid #606367', borderRadius: 1.5}} size="small" aria-label="a dense table" display="flex" >
              <TableHead>
                <TableRow>
                  ...
                  {showCluster3 && <TableCell align="center" colSpan={5} sx={{ color: "#ffffff", bgcolor: "#17181a", borderBottom: 0, borderRight: '1px solid #606367' }}>{`CIRCUIT TYPE: ${data5} - CIRCUITS SIMILAR TO ${data4}`}</TableCell>}
                  ...
                  {data2.map((row, i) => (
                    ...
                    >
                      <TableCell sx = {{ color: "#ffffff", bgcolor: "#17181a", borderBottom: '1px solid #606367', borderRight: '1px solid #606367' }}>Driver</TableCell>
                      {showCluster1 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.fiveRacesAgoReport}  target="_blank" rel="noopener noreferrer">{row.fiveRacesAgo}</a></TableCell>}
                      {showCluster1 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.fourRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.fourRacesAgo}</a></TableCell>}
                      {showCluster1 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.threeRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.threeRacesAgo}</a></TableCell>}
                      {showCluster1 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.twoRacesAgoReport} target="_blank" rel="noopener noreferrer">{row.twoRacesAgo}</a></TableCell>}
                      {showCluster1 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367', borderRight: '1px solid #606367' }}><a href={row.oneRaceAgoReport} target="_blank" rel="noopener noreferrer">{row.oneRaceAgo}</a></TableCell>}
                      {showCluster2 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRace1Report} target="_blank" rel="noopener noreferrer">{row.nextRace1}</a></TableCell>}
                      {showCluster2 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRace2Report} target="_blank" rel="noopener noreferrer">{row.nextRace2}</a></TableCell>}
                      {showCluster2 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRace3Report} target="_blank" rel="noopener noreferrer">{row.nextRace3}</a></TableCell>}
                      {showCluster2 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRace4Report} target="_blank" rel="noopener noreferrer">{row.nextRace4}</a></TableCell>}
                      {showCluster2 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367', borderRight: '1px solid #606367' }}><a href={row.nextRace5Report} target="_blank" rel="noopener noreferrer">{row.nextRace5}</a></TableCell>}
                      {showCluster3 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRaceType1Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType1}</a></TableCell>}
                      {showCluster3 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRaceType2Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType2}</a></TableCell>}
                      {showCluster3 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRaceType3Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType3}</a></TableCell>}
                      {showCluster3 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRaceType4Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType4}</a></TableCell>}
                      {showCluster3 && <TableCell align="center" sx={{ bgcolor: "#17181a", borderBottom: '1px solid #606367' }}><a href={row.nextRaceType5Report} target="_blank" rel="noopener noreferrer">{row.nextRaceType5}</a></TableCell>}
                    </TableRow>
                  ))}
                </TableHead>
                <TableBody>

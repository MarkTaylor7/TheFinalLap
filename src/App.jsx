...
export default function App() {
  ...
  }, [currentSeasonRaceResults, lastFiveRaceResults, nextRaceHistory, nextRaceTypeHistory]);

  //useEffect(() => {
  // console.log(driverTableData); (consider renaming the title of mapNamesAndResultsToDrivers to this)
  //}, [driverTableData]);

  //This function formats each row of the main table so that it matches up with the rows in DenseTable.jsx
  function formatRow(
    name,
    fiveRacesAgo,
    fourRacesAgo,

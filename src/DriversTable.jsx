...
export const DriversTable = () => {
  ...
  const entriesData = [
    ...
    { teamName: 'Williams Racing', chassis: 'FW46', powerUnit: 'Mercedes', teamFlag: `https://flagsapi.com/GB/flat/${flagSize}.png`, driverNumbers: ['23', '43'], driverNames: ['Alexander Albon', 'Franco Colapinto'], driverFlags: [`https://flagsapi.com/TH/flat/${flagSize}.png`, `https://flagsapi.com/AR/flat/${flagSize}.png`], bgColor: '#65c0f8', color: '#000000', puColor: '#28efcb' },

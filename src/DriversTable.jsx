        ...
        <TableBody style={{ paddingTop: 0, paddingBottom: 0 }}>
          {entriesData.map((entry, index) => (
            <TableRow key={index} >
              ...
              <TableCell align='left' style={{ padding: isSmallScreen ? '5px' : null, fontSize: isSmallScreen ? '10px' : '16px', fontFamily: 'Bai Jamjuree, Helvetica', paddingTop: '5px', paddingBottom: '5px', backgroundColor: entry.bgColor, color: entry.color, borderLeft: 'none'}}>{entry.teamName}</TableCell>
              <TableCell align='right' style={{ padding: isSmallScreen ? '5px' : null, fontSize: isSmallScreen ? '10px' : '16px', paddingTop: '5px', paddingBottom: '5px', borderRight: 'none', lineHeight: isSmallScreen ? '15px' : '30px' }}>{entry.driverNumbers[0]}<br/>{entry.driverNumbers[1]}</TableCell>
              <TableCell align='left' style={{ padding: isSmallScreen ? '5px' : null, fontSize: isSmallScreen ? '10px' : '16px', paddingTop: '5px', paddingBottom: '5px', width: isSmallScreen ? '26%' : '18%', paddingRight: 0, borderLeft: 'none', borderRight: 'none', lineHeight: isSmallScreen ? '15px' : '30px' }}>{entry.driverNames[0]}<br/>{entry.driverNames[1]}</TableCell>
              ...
              <TableCell align='center' style={{ padding: isSmallScreen ? '5px' : null, fontSize: isSmallScreen ? '10px' : '16px', paddingTop: '5px', paddingBottom: '5px' }}>{entry.chassis}</TableCell>
              <TableCell align='center' style={{ padding: isSmallScreen ? '5px' : null, fontSize: isSmallScreen ? '10px' : '16px', paddingTop: '5px', paddingBottom: '5px', color: entry.puColor }}>{entry.powerUnit}</TableCell>
